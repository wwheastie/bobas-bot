...
public interface PayoutTimeRepository extends CrudRepository<PayoutTimeDao, String> {
	...
	void savePayoutTime(@Param("channelId") String channelId, @Param("userName") String userName, @Param("payoutTime") Time payoutTime,
			@Param("flag") String flag, @Param("swgohggLink") String swgohggLink);
